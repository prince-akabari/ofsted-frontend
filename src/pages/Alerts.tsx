    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="border-b border-border bg-card">
        <div className="px-6 py-4">
          ...
          <p className="text-muted-foreground">Stay informed about important actions and deadlines</p>
        </div>
      </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Card className="p-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-destructive">{alertsData.filter(a => a.type === 'danger').length}</div>
              <div className="text-sm text-muted-foreground">Critical</div>
            </div>
          </Card>
          <Card className="p-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-warning">{alertsData.filter(a => a.type === 'warning').length}</div>
              <div className="text-sm text-muted-foreground">Warnings</div>
            </div>
          </Card>
          <Card className="p-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-primary">{alertsData.filter(a => a.urgent).length}</div>
                  ...
                  <div className="flex items-start space-x-3 flex-1">
                    ...
                    <div className="space-y-1 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        <Badge className={getAlertBadge(alert.type)}>{alert.type.toUpperCase()}</Badge>
                        {alert.urgent && <Badge className="bg-destructive text-destructive-foreground">URGENT</Badge>}
                      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <label className="flex items-center space-x-2">
                    <input type="checkbox" defaultChecked className="w-5 h-5 rounded border-2 border-primary text-primary focus:ring-primary focus:ring-2 focus:ring-offset-0" />
                    <span className="text-sm">DBS expiry reminders (30 days)</span>
                  </label>
                  <label className="flex items-center space-x-2">
                    <input type="checkbox" defaultChecked className="w-5 h-5 rounded border-2 border-primary text-primary focus:ring-primary focus:ring-2 focus:ring-offset-0" />
                    <span className="text-sm">Training expiry alerts (14 days)</span>
                  </label>
                  <label className="flex items-center space-x-2">
                    <input type="checkbox" defaultChecked className="w-5 h-5 rounded border-2 border-primary text-primary focus:ring-primary focus:ring-2 focus:ring-offset-0" />
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <label className="flex items-center space-x-2">
                    <input type="checkbox" className="w-5 h-5 rounded border-2 border-primary text-primary focus:ring-primary focus:ring-2 focus:ring-offset-0" />
